            ...
            <div className='flex-grow flex flex-wrap md:pl-20 mb-10 md:mt-0 mt-10 md:text-left text-center'>
                ...
                <div className='lg:w-1/4 md:w-1/2 w-full px-4'>
                    ...
                    <ul className='list-none mb-10'>
                        ...
                        <li className='mt-1'>1234893506</li>
                        <li className='mt-1'>News Blog</li>
                        <li className='mt-1'>98459274985</li>
                    </ul>
                </div>
                <div className='lg:w-1/4 md:w-1/2 w-full px-4'>
                    <h2 className='title-font font-medium tracking-widest text-lg mb-3'>
        ...
        <div className='bg-gray-500 text-white'>
                    <div className='container mx-auto py-4 px-5 flex flex-wrap justify-between flex-col sm:flex-row'>
                        <p className='text-sm text-center sm:text-left'>
                            @ 2024 ECommerce <span>@copyright</span>

                        </p>
                        <p className='inline-flex sm:ml:ml-auto sm:mt-0 mt-2  justify-center sm:justify-start'>
                            <span className='mr-4'>
                            <FaFacebook size={30}/>
                            </span>
                            <span className='mr-4'>
